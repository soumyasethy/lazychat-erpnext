...
Reused the existing two-phase pattern + the same `commit_prepared_action` endpoint extended with a `fields` extra. New component lives at [FieldPickerCard.tsx](/Users/soumyasethy/Desktop/code-chat/lazychat.ai/apps/chat-ui/src/components/messages/FieldPickerCard.tsx).
